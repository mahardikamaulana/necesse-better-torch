...
public class PhoenixLampObject extends OutdoorLampObject {

    private GameTexture texture;
    private GameTexture texture_off;

    public PhoenixLampObject(int lightLevel, float lightHue, float lightSat) {
    ...
    public void loadTextures() {
        super.loadTextures();
        this.texture = GameTexture.fromFile("objects/phoenixLamp");
        this.texture_off = GameTexture.fromFile("objects/phoenixLamp_off");
    }
    ...
    public void addLayerDrawables(List<LevelSortedDrawable> list, OrderableDrawables tileList, Level level, int layerID, int tileX, int tileY, TickManager tickManager, GameCamera camera, PlayerMob perspective) {
        ...
        list.add(new LevelSortedDrawable(this, tileX, tileY) {
            ...
            public void draw(TickManager tickManager) {
                Performance.record(tickManager, "phoenixLampDraw", () -> options.draw());
            }
        });
    }
